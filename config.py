...
# --- Summarizer -------------------------------------------------------------
# LLM used to compress conversation history into a running summary so that
# long sessions stay within the context-window budget.
LLM_MODEL = os.environ.get("SUMMARIZER_MODEL", "claude-sonnet-4-20250514")
SUMMARIZER_MAX_TOKENS = int(os.environ.get("SUMMARIZER_MAX_TOKENS", "256"))
SUMMARIZER_TEMPERATURE = float(os.environ.get("SUMMARIZER_TEMPERATURE", "0.0"))
